...
export type File_Error = ['make directory', d_make_directory.Errors] | ['write file', d_write_file.Errors];
export type Directory_Error = ['remove', d_remove.Errors] | ['nodes', _et.Dictionary<Node_Error>];
